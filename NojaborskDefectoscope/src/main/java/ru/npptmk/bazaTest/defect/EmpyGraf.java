...
/**
 * Постащик результатов для очистки графика.
 * @author MalginAS
 */
public class EmpyGraf implements Serializable,IDefectScanDataProvider, IThickScanDataProvider,
        IScanDataProvider {

    private final long devId;

    public EmpyGraf(long devId) {
        this.devId = devId;
    }
