 ...
 * @author MalginAS
 */
public class GraphicsPnlDfParamDialog extends javax.swing.JDialog implements ListSelectionListener {

    private final GraphicsPnlDfParams par;
     ...
     * @param usk2
     */
    public GraphicsPnlDfParamDialog(GraphicsPnlDfParams par, DeviceUSKUdp usk1, DeviceUSKUdp usk2) {
    ...
    private void btAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddActionPerformed
        ...
        switch (unit) {
            ...
            case "УЗК1":
                cchan = 0;
                for (int i = 0; i < 8; i++) {
                    if (usk1.getParams().prms[i].getHardware_type() == DeviceUSKUdpParam.FLAW_CONTROL) {
                        cchan++;
                    }
                }
                chans = new String[cchan];
            ...
            case "УЗК2":
                cchan = 0;
                for (int i = 0; i < 8; i++) {
                    if (usk2.getParams().prms[i].getHardware_type() == DeviceUSKUdpParam.FLAW_CONTROL) {
                        cchan++;
                    }
                }
                chans = new String[cchan];
