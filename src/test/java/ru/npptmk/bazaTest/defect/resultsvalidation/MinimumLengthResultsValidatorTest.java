 ...
 * @author razumnov
 */
public class MinimumLengthResultsValidatorTest {
    ...
    public MinimumLengthResultsValidatorTest() {
    }

    @Test
    public void testTest() {
        MinimumLengthResultsValidator instance = new MinimumLengthResultsValidator(6_000);
